...
Breaking changes are in rarely used functionality, so we hope upgrade will be smooth for most appUsers.
 ...
 * Ensure not to use default parsers when there is a appUser defined one. (kof)
...
* Set default appUser-agent header. (bevacqua)
